    ...
    <section>
      <div className="flex flex-wrap gap-10 mx-6 xl:mx-[186px] mt-20 lg:mt-40">
        <div className=" items-center   xl:mt-10">
          ...
          <div className="xl:text-2xl 2xl:w-[730px] tracking-[0.48px]  w-11/12 text-grey-600  mt-[30px] !leading-[180%]">
            TOTC’s school management software helps traditional and online
            schools manage scheduling, attendance
            <div className="bg-normal-teal text-2xl xl:text-4xl h-6 right-0 lg:left-[46%] absolute transition  w-6  rounded-full -mt-2 ms-1"></div>
