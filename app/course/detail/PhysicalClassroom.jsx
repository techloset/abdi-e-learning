    ...
    <section>
      <div className=" grid lg:grid-cols-2 gap-10 mx-6 lg:mx-[186px] mt-20 mb-16 lg:mt-[200px] lg:mb-[163px]">
        <div className=" items-center   xl:mt-10">
          <div className="bg-normal-teal text-2xl xl:text-4xl font-bold h-12 text-normal-purple  absolute transition  w-12   rounded-full "></div>
          <h1 className="text-normal-purple text-2xl xl:text-4xl font-bold relative z-10">
          ...
          <div className="xl:text-2xl 2xl:w-3/4   w-11/12 text-gray-600  mt-5">
            ...
            <div className="bg-normal-teal text-2xl xl:text-4xl font-bold h-6 mx-28 right-0 lg:left-1/3  absolute transition  w-6  rounded-full ">
              {" "}
            </div>
