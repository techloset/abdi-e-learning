...
function Radar() {
  return (
    <section>
      <div className="md:mx-14 mx-6 lg:mx-20 xl:mx-[120px] pt-[80px]">
        <p className="font-semibold  text-[44px] text-[#2F327D] ">
          Why Swift UI Should Be on the Radar of Every Mobile Developer
        </p>

        <p className="text-[#696984] text-2xl leading-[180%] max-w-[1681px] mt-[25px]">
        ...
        <p className="text-[#696984] text-2xl leading-[180%] max-w-[1681px] mt-[30px]">
          TOTC is a platform that allows educators to create online classes
          whereby they can store the course materials online; manage
          assignments, quizzes and exams; monitor due dates; grade results and
          provide students with feedback all in one place. <br /> TOTC is a
        ...
        <div className="flex flex-col sm:flex-row mt-[26px]">
          <button className="bg-[#49BBBD1A] text-[#696984] px-6 py-3 mx-4 my-2 sm:my-0  rounded-full ">
            affordable
          </button>
          <button className="bg-[#49BBBD1A] text-[#696984] px-6 py-3 mx-4 my-2 sm:my-0 rounded-full ">
            Stunning
        ...
        <hr className="bg-[#696984] h-[1px] mt-[31px]" />
        ...
        <div className="flex justify-between items-center my-[30px]">
          ...
          <button className=" w-[150px] md:w-[232px] h-[49px] text-[#49BBBD] font-semibold  border-[#49BBBD] rounded-xl border">
            Follow
          </button>
        </div>
      </div>
