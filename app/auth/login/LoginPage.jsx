...
import girlImage from "../../assets/auth/login/loginPageGirl.png";
    ...
    <div className="flex items-center justify-center my-28 md:my-9 bg-white">
      ...
      <div className="flex flex-col mx-auto">
        <div className="flex flex-col mx-auto">
          ...
          <div className="w-[315px] md:w-[329px] h-[59px] mt-6 flex justify-around items-center bg-[#49BBBD] bg-opacity-60 rounded-[33px]">
            <div className="bg-[#49BBBD] rounded-[33px] px-10 py-2 text-white text-base font-medium">
              Login
            </div>
        ...
        <div className="form-group mt-[42px]">
          ...
          <input
            ...
            className="pt-[15px] pb-[16px] ps-[31px] mt-3 block w-[318px] md:w-[435px] bg-white rounded-[40px] border border-[#49BBBD] bg-transparent text-neutral-400 text-[15px] font-normal"
          />
        </div>
        ...
        <div className="flex justify-between mt-[22px]">
          <div className="form-group flex">
            <input type="checkbox" />
            <div className="ms-[10px]  text-black text-xs font-light">
              Rememebr me
            </div>
          </div>
          <div className="left-[324px] top-0  text-black text-xs font-light">
            Forgot Password?
          </div>
        </div>
        <div className="btn mt-[62px] ms-auto me-4">
          <button className="w-[232px] h-[49px] bg-[#49BBBD] rounded-[36px]">
            Login
          </button>
        </div>
      </div>
