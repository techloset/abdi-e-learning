...
function KnowAbout() {
  return (
    <section className="mb-[65px]">
      <div className="bg-[#9DCCFF] bg-opacity-20 mx-12 lg:mx-28 2xl:mx-[119px] lg:p-14 2xl:px-[120px] 2xl:py-8 p-6 rounded-[20px] flex-col xl:flex-row justify-between flex gap-8">
        <div className="flex flex-col justify-center">
          <p className="font-semibold lg:text-3xl 2xl:w-[331px] text-2xl mb-6">
          ...
          <button className="lg:text-2xl text-xl font-extrabold text-white rounded-xl w-[309px] h-[63px] bg-[#49BBBD] ">
            Start learning now
          </button>
        </div>
