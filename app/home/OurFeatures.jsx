...
function OurFeatures() {
  return (
    <section>
      <h1 className="text-[#2F327D] text-3xl lg:text-4xl !font-bold text-center justify-center mt-20 xl:mt-44 mb-5 !leading-[180%]">
        Our<span className="text-[#00CBB8]"> Features</span>
      </h1>

      <p className=" text-xl xl:text-2xl text-center justify-center mx-auto text-[#696984] !leading-[180%]">
