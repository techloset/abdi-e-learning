...
function Explore() {
  return (
    <section
      ...
      className=" bg-opacity-75 mt-[57px] xl:pt-72 xl:pb-40 rounded-br-3xl ps-[155px] pe-[50px] font-roboto-imp"
    >
      <div className="">
        <h1 className="font-bold text-[40px] -ms-6">Explore Courses</h1>
        <br />
        ...
        <div className="top">
          ...
          <div className="relative z-10 mt-12">
            <div className="flex justify-between ">
              <div className="book hidden 2xl:block shadow text-center  bg-white  rounded-3xl py-3 px-4  text-white max-w-[105px] 2xl:w-[105px] max-h-[418px]">
          ...
          <div className="h-16 -ms-6 -mt-8 hidden xl:block absolute w-[90.5%] bg-black rounded-xl opacity-5  "></div>
        </div>
        {/* ========================================Top ================================= */}
