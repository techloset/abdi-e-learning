    ...
    <div className=" bg-[#9DCCFF] bg-opacity-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mx-6 lg:mx-16 xl:mx-20 gap-8 xl:gap-16 2xl:my-[70px] ">
        <div className="">
          ...
          <br />
          <h1 className="font-semibold text-2xl md:text-3xl xl:text-4xl text-[#2F327D]">
            Why Swift UI Should Be on the <br /> Radar of Every Mobile <br />{" "}
            Developer
          </h1>
          <br />
          <p className=" text-lg xl:text-xl text-[#696984] ">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, <br />
            sed do eiusmod tempos Lorem ipsum dolor sitamet, <br /> consectetur
            adipiscing elit, sed do eiusmod tempor
          </p>
          <br />
          <button className="bg-[#49BBBD] text-white rounded-2xl px-11 py-4 text-base font-bold">
            Start learning now
          </button>
        </div>
