  ...
  return (
    <div>
      <div className="pt-[74px] pb-10 bg-gray-800 text-center justify-center mx-auto center items-center content-center ">
        ...
        <div>
          <p className="sm:text-[26px] text-gray-500 mt-24 mb-5 font-medium">
        ...
        <div className="flex-row">
          <input
            type="text"
            className="mx-5 sm:my-0 mb-6  rounded-full border font-normal px-7 py-3 sm:text-[20px] border-slate-100 bg-gray-800 text-gray-600"
            name=""
            id=""
            placeholder="Your Email"
          />

          <button className="sm:text-[22px]  font-semibold text-white bg-teal-400  rounded-full px-8 py-3">
            Subscribe
          </button>
        </div>
